...
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(255,182,193), stop:1 rgb(250,250,210));\n"
...
"}")
        ...
        #################################logo
        self.TopLogoInfo = QFrame(self.LeftMenuBg) #左侧菜单栏是logo的父部件，logo又是作者信息与logo信息的父类
...
"}")
        ...
        ##############################################################################用户管理
        self.user_management_button = QPushButton(self.MenuBox)
        self.user_management_button.setObjectName(u"user_management_button")
        self.user_management_button.setMinimumSize(QSize(0, 45))
        self.user_management_button.setCursor(QCursor(Qt.PointingHandCursor))
        self.user_management_button.setStyleSheet(u"QPushButton{\n"
                                           "background-image: url(:/all/img/user.png);\n"
                                           "background-repeat: no-repeat;\n"
                                           "background-position: left center;\n"
                                           "border: none;\n"
                                           "border-left: 23px solid transparent;\n"
        ...
        self.verticalLayout_5.addWidget(self.user_management_button)
...
"}")
        ...
        self.Class_QF.setMinimumSize(QSize(240, 80))
        self.Class_QF.setMaximumSize(QSize(240, 80))
...
"")
        ...
        self.label_5.setStyleSheet(u"color: rgba(255,255,255,255);\n"
"padding-left:12px;\n"
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Target_QF.setMinimumSize(QSize(240, 80))
        self.Target_QF.setMaximumSize(QSize(240, 80))
...
################################################################FPS的参数
        ...
        self.Fps_QF.setMinimumSize(QSize(240, 80))
        self.Fps_QF.setMaximumSize(QSize(240, 80))
...
########################################################################模型选择的参数
        ...
        self.Model_QF.setMinimumSize(QSize(240, 80))
        self.Model_QF.setMaximumSize(QSize(240, 80))
...
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(255,182,193), stop:1 rgb(250,250,210));\n"
...
"}")
        ...
        self.verticalLayout_22.setContentsMargins(15, 15, -1, -1) #分别表示左侧、顶部、右侧和底部的外边距值。在这里，参数分别是 (15, 15, -1, -1)
...
#        self.Title.setText(QCoreApplication.translate("MainWindow", u"MTAS", None))
        ...
        self.user_management_button.setText(QCoreApplication.translate("MainWindow", u"  用户管理", None))
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"基于YOLOv8的智慧车流检测与统计分析系统", None))
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"AVG_FPS", None))
